...
public class Layer_n05 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        velocity = 0.8f * _parallaxControler._overrallSpeed;
    ...
    private void OnBecameInvisible() {
        GameObject layerTemporaria5 = Instantiate(_parallaxControler.bg_layer_n05);
